...
namespace DA.AI
{
    public class DragonBehaviorYi_playerdragon : DADragonAIAgentBase
    {
        ...
        public DADragonFlightAISpawner originalSpawner;
        public float x;
        public float y;
        public float z;
        Vector3 pos;
        ...
        public override void Initialize()
        {
            ...
            vally_target = GameObject.FindGameObjectWithTag("reward_wall");
        }
        ...
        {   
            ...
            positions[0] = new Vector3(96.6f,10f,149.1f);
            positions[1] = new Vector3(-54.1f,3.52f,82.6f);
            positions[2] = new Vector3(-50.1f,-14.7f,232.8f);
            positions[3] = new Vector3(76f,-29.1f,326f);
            ...
            //transform.position = originalSpawner.SpawnPoint.position;
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            // {
            //     collidetarget = true;
            //     Debug.Log("----------------------touch dragon--------------------");
            // }
            if (other.CompareTag("reward_wall") == true)
            {
                AddReward(0.1f);
        ...
        {
            // if (collider.CompareTag("player") && collidetarget == true)
            // {
            //     if (isTraining)
            //     {
            //         AddReward(10f);
            ...
            if (collider.CompareTag("reward_wall") == true)
            {
                AddReward(0.1f);
                //Debug.Log("-----=----------------enter wall--------------------");
            }
